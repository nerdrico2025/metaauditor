...
CREATE TABLE "performance_benchmarks" (
	...
	"user_id" varchar NOT NULL,
	"ctr_min" numeric(5, 3),
	"ctr_target" numeric(5, 3),
	"cpc_max" numeric(10, 2),
	"cpc_target" numeric(10, 2),
	"conversions_min" integer,
...
ALTER TABLE "performance_benchmarks" ADD CONSTRAINT "performance_benchmarks_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
