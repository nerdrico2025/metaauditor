                  ...
                  <div className="relative">
                    <img 
                      ...
                      onError={(e) => {
                        ...
                        if (parent) {
                          parent.innerHTML = `
                            <div class="w-full h-48 bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg flex flex-col items-center justify-center border-2 border-dashed border-orange-200">
                              <svg class="h-12 w-12 text-orange-400 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                              </svg>
                              <span class="text-sm text-orange-600 font-medium text-center px-4">
                                ${creative.name}
                              </span>
                              <span class="text-xs text-orange-400 mt-2">Imagem não disponível (URL expirada)</span>
                            </div>
                          `;
                        }
                      }}
