...
export default function SettingsPolicies() {
  ...
  const updateMutation = useMutation({
    ...
    onError: (error: any) => {
      console.error("🚨 SettingsPolicies Mutation Error:", {
        error,
  ...
  return (
    <div className="flex h-screen bg-slate-50">
      ...
      <div className="flex flex-col flex-1 overflow-hidden">
        <Header title="Configurações de Auditoria" />
        
        <main className="flex-1 overflow-y-auto">
          <div className="py-6">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="mb-6">
                <h1 className="text-3xl font-bold text-slate-900">Configurações de Auditoria</h1>
                        ...
                        <form onSubmit={brandForm.handleSubmit(onSubmitBrandPolicies)} className="space-y-6">
                          ...
                          <div>
                            ...
                            <div className="mt-4 space-y-4">
                              ...
                              <div className="flex items-center justify-between">
                                <div>
                                  <Label htmlFor="autoFixMinor">Correção Automática Menor</Label>
                                  <p className="text-sm text-slate-600">Corrigir automaticamente problemas menores detectados</p>
                                </div>
                                <Switch 
                                  id="autoFixMinor"
                ...
                <TabsContent value="validation-criteria">
                  <Card data-testid="card-validation-criteria">
                    <CardHeader>
                      ...
                      <CardDescription>
                        Configure palavras, termos, frases e requisitos para validação de conteúdo
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      {settingsLoading ? (
                        ...
                        <form onSubmit={criteriaForm.handleSubmit(onSubmitValidationCriteria)} className="space-y-6">
                          {/* Keywords Section */}
                          <div>
                            <Label className="text-base font-medium">Palavras Obrigatórias</Label>
                            <p className="text-sm text-slate-600 mb-2">Palavras que devem estar presentes no conteúdo</p>
                            <ChipsInput
                              value={criteriaForm.watch("requiredKeywords")}
                              onChange={(value) => criteriaForm.setValue("requiredKeywords", value)}
                          ...
                          <div>
                            ...
                            <p className="text-sm text-slate-600 mb-2">Palavras que não podem aparecer no conteúdo</p>
                            <ChipsInput
                              value={criteriaForm.watch("forbiddenTerms")}
                              onChange={(value) => criteriaForm.setValue("forbiddenTerms", value)}
                          ...
                          <div>
                            <Label className="text-base font-medium">Frases Requeridas</Label>
                            <p className="text-sm text-slate-600 mb-2">Frases específicas que devem estar presentes</p>
                            <ChipsInput
                              value={criteriaForm.watch("requiredPhrases")}
                              onChange={(value) => criteriaForm.setValue("requiredPhrases", value)}
                            ...
                            <div className="mt-4 space-y-4">
                              <div className="flex items-center justify-between">
                                <div>
                                  ...
                                  <p className="text-sm text-slate-600">O criativo deve conter o logo da marca</p>
                                </div>
                                <Switch 
                                  id="requireLogo"
                              ...
                              <div className="flex items-center justify-between">
                                <div>
                                  ...
                                  <p className="text-sm text-slate-600">O criativo deve usar as cores definidas da marca</p>
                                </div>
                                <Switch 
