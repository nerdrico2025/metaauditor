...
import { cn, getCreativeImageSrcCandidates, isSupabaseStorageUrl } from '@/lib/utils';
...
export function CreativeMediaPreview({
  ...
  const isPrivateStorageVideo = !!(videoUrl && isSupabaseStorageUrl(videoUrl));
  const canHoverPlay = interactive && isVideo && !!videoUrl && !reduced && !isPrivateStorageVideo;
