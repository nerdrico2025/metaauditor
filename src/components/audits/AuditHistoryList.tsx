...
interface AuditHistoryListProps {
    ...
    crossFocusByCreativeId?: Map<string, CrossFocusDisplayStatus>;
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <div className="flex items-center gap-2 mb-2 flex-wrap">
                                    ...
                                    {kind === 'creative' && crossFocusOpposite && crossFocusByCreativeId && audit.creative_id && (
                                        <CrossFocusStatusBadge
                                            oppositeFocus={crossFocusOpposite}
                                            status={crossFocusByCreativeId.get(audit.creative_id) ?? 'none'}
                                        />
                                    )}
                                    {showEntityBadges && (
