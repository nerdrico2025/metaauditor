    ...
    return (
        <div className="space-y-6 animate-in slide-in-from-right-4">
            <div className="space-y-2">
                <h2 className="text-xl font-semibold text-foreground">Definições da Campanha</h2>
                <p className="text-sm text-muted-foreground">Selecione a conta de anúncio e o objetivo principal.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                    ...
                    <Select value={integrationId} onValueChange={setIntegrationId}>
                        <SelectTrigger id="integration" className="bg-input border-input text-foreground">
                ...
                <div className="space-y-2">
                    ...
                    <Select value={data.objective} onValueChange={(v) => updateData({ objective: v })}>
                        <SelectTrigger id="objective" className="bg-input border-input text-foreground">
                    ...
                    <p className="text-xs text-muted-foreground">Selecione o objetivo que melhor se aplica ao seu negócio.</p>
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <Select value={data.status} onValueChange={(v) => updateData({ status: v as 'ACTIVE' | 'PAUSED' })}>
                        <SelectTrigger id="status" className="bg-input border-input text-foreground">
