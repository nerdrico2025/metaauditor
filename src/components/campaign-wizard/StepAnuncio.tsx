    ...
    return (
        <div className="space-y-6 animate-in slide-in-from-right-4">
            <div className="space-y-2">
                <h2 className="text-xl font-semibold text-foreground">Criativo do Anúncio</h2>
                <p className="text-sm text-muted-foreground">Configure a identidade visual e o texto do seu anúncio.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-xs text-muted-foreground">Esta página representará seu anúncio.</p>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        />
                        <p className="text-xs text-muted-foreground">Cole o link direto da imagem do seu criativo.</p>
                    </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <Textarea
                            ...
                            className="bg-input border-input text-foreground h-32"
            ...
            <div className="mt-8 p-4 border border-border rounded-lg bg-ch-bg/50">
                <h3 className="text-sm font-medium text-muted-foreground mb-4 uppercase text-center tracking-wider">Pré-visualização (Estilo Feed)</h3>
