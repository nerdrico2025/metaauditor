    ...
    return (
        <div className="space-y-6 animate-in slide-in-from-right-4">
            <div className="space-y-2">
                <h2 className="text-xl font-semibold text-foreground">Conjunto de Anúncios</h2>
                <p className="text-sm text-muted-foreground">Defina quem verá seus anúncios e quanto você quer gastar.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">Valor mínimo recomendado: R$ 6,00</p>
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <Select value={data.optimization_goal} onValueChange={(v) => updateData({ optimization_goal: v as any })}>
                        <SelectTrigger id="optimization" className="bg-input border-input text-foreground">
                ...
                <div className="space-y-2">
                    ...
                    <Select value={data.billing_event} onValueChange={(v) => updateData({ billing_event: v as any })}>
                        <SelectTrigger id="billing" className="bg-input border-input text-foreground">
                ...
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        className="bg-input border-input text-foreground w-full block"
                    />
                </div>

                {/* Targeting Simplificado */}
                <div className="col-span-1 md:col-span-2 space-y-4 p-4 border border-input rounded-lg bg-ch-bg/50">
                    <h3 className="text-md font-medium text-foreground">Público Alvo (Targeting)</h3>
                    ...
                    <div>
                        ...
                        <div className="p-2 bg-input rounded text-sm text-muted-foreground mt-1">
