                                    ...
                                    {isBranding ? (
                                        ...
                                        <div className="flex items-start gap-0">
                                            {[
                                                ...
                                                { label: t('campaigns:metrics.impressions'), icon: <Eye className="w-3 h-3 text-blue-500" />, value: formatNumber(campaign.insights?.reduce((sum, i) => sum + (Number(i.impressions) || 0), 0) || 0), always: false },
                                                { label: t('campaigns:metrics.clicks'), icon: <MousePointer className="w-3 h-3 text-purple-500" />, value: formatNumber(campaign.insights?.reduce((sum, i) => sum + (Number(i.clicks) || 0), 0) || 0), always: true },
