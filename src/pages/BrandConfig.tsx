...
export default function BrandConfig() {
    ...
    return (
        <div className="p-8 max-w-4xl mx-auto">
            <div className="mb-8">
                <h1 className="text-2xl font-bold text-foreground mb-2">Configurações de Marca</h1>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex gap-2">
                                <Input
                                    ...
                                    className="w-12 h-10 p-1 bg-muted border-border cursor-pointer"
                                />
                                <Input
                                    value={primaryColor}
                                    onChange={(e) => setPrimaryColor(e.target.value)}
                ...
                <div className="glass rounded-xl p-6">
                    ...
                    <div className="flex flex-wrap gap-2">
                        ...
                        {forbiddenWords.length === 0 && (
                            <span className="text-muted-foreground text-sm">Nenhuma palavra adicionada</span>
                        )}
                    </div>
                </div>
                ...
                <div className="glass rounded-xl p-6">
                    ...
                    <div className="flex flex-wrap gap-2">
                        ...
                        {requiredElements.length === 0 && (
                            <span className="text-muted-foreground text-sm">Nenhum elemento adicionado</span>
                        )}
                    </div>
                </div>
