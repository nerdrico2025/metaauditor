...
export default function Billing() {
    ...
    return (
        <div className="p-8 max-w-6xl mx-auto">
            <div className="mb-8">
                <h1 className="text-2xl font-bold text-foreground mb-2">Planos e Faturamento</h1>
                        ...
                        >
                            ...
                            <Button
                                ...
                                className={`w-full ${plan.popular
                                        ...
                                        : 'bg-muted hover:bg-ch-gray border border-border'
                                    }`}
                            >
            ...
            <div className="mt-12 glass rounded-xl p-6">
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        <p className="font-medium text-foreground">Posso mudar de plano?</p>
                        <p className="text-sm text-muted-foreground mt-1">
                            Sim, você pode fazer upgrade ou downgrade a qualquer momento. A diferença será calculada proporcionalmente.
                        </p>
                    </div>
                    <div>
                        <p className="font-medium text-foreground">O que acontece se eu exceder os limites?</p>
                        <p className="text-sm text-muted-foreground mt-1">
