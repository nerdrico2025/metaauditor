                        ...
                        {recentAudits && recentAudits.length > 0 ? (
                            recentAudits.map((audit) => (
                                ...
                                >
                                    ...
                                    <div className={`flex flex-col items-center justify-center w-20 h-20 rounded-[1.3rem] border-2 transition-all group-hover:rotate-6 ${audit.compliance_score !== null && audit.compliance_score >= 80 ? 'bg-emerald-500/5 border-emerald-500/20 text-emerald-500' :
                                        audit.compliance_score !== null && audit.compliance_score >= 50 ? 'bg-amber-500/5 border-amber-500/20 text-amber-500' :
                                            'bg-rose-500/5 border-rose-500/20 text-rose-500'
                                        }`}>
                                        <span className="text-[10px] font-medium opacity-60 mb-1">Score</span>
                                        <span className="text-xl font-bold tabular-nums">{audit.compliance_score ?? '-'}%</span>
                                    </div>
                                </div>
                            ))
                        ) : (
