    ...
    if (type === 'visual') {
        ...
        if (contentSpec.cta_required) {
            if (contentSpec.cta_terms) {
                parts.push(`CTA OBRIGATÓRIO: O criativo deve ter um Call to Action usando um dos termos: ${contentSpec.cta_terms}.`);
            } else {
                parts.push('CTA OBRIGATÓRIO: O criativo deve ter um Call to Action claro e visível.');
            }
        }
        ...
        if (contentSpec.headline_required) {
            parts.push('HEADLINE OBRIGATÓRIA: O criativo deve ter uma headline (título) clara e objetiva.');
        }
