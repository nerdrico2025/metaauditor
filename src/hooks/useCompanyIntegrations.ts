...
import { supabase, type IntegrationClient } from "@/integrations/supabase/client";
import { INTEGRATION_PUBLIC_COLUMNS } from "@/lib/integrationColumns";
...
export type IntegrationWithMetrics = IntegrationClient & {
    metrics?: IntegrationMetrics;
    is_monitored?: boolean;
    access_token?: string;
    refresh_token?: string;
    sync_preferences?: any;
};
...
export function getIntegrationStatus(integration: IntegrationClient): {
