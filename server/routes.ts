...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.put('/api/integrations/:id', authenticateToken, async (req: AuthRequest, res) => {
    try {
  ...
  app.delete('/api/integrations/:id', authenticateToken, async (req: AuthRequest, res) => {
    try {
      const integrationId = req.params.id;
      const userId = req.user!.id;
  ...
  // Policy routes
  app.get('/api/policies', authenticateToken, async (req: AuthRequest, res) => {
    try {
      const userId = req.user!.id;
  ...
  app.post('/api/policies', authenticateToken, async (req: AuthRequest, res) => {
    try {
      const userId = req.user!.id;
  ...
  app.put('/api/policies/:id', authenticateToken, async (req: AuthRequest, res) => {
    try {
      const policyId = req.params.id;
  ...
  app.delete('/api/policies/:id', authenticateToken, async (req: AuthRequest, res) => {
    try {
      const policyId = req.params.id;
  ...
  // Creative routes
  app.get('/api/creatives', authenticateToken, async (req: AuthRequest, res) => {
    try {
      const userId = req.user!.id;
  ...
  app.post('/api/creatives', authenticateToken, async (req: AuthRequest, res) => {
    try {
      const userId = req.user!.id;
  ...
  // Audit Action routes
  app.get('/api/audit-actions', authenticateToken, async (req: AuthRequest, res) => {
    try {
      const userId = req.user!.id;
  ...
  app.post('/api/audit-actions', authenticateToken, async (req: AuthRequest, res) => {
    try {
      const userId = req.user!.id;
  ...
  app.get('/api/dashboard/problem-creatives', authenticateToken, async (req: AuthRequest, res) => {
    try {
      const userId = req.user!.id;
  ...
  // AI Analysis routes
  app.post('/api/analyze/compliance', authenticateToken, async (req: AuthRequest, res) => {
    try {
  ...
  app.post('/api/analyze/performance', authenticateToken, async (req: AuthRequest, res) => {
    try {
  ...
  // Store storage instance for auth middleware
